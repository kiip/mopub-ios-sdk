...
#import "KPKiipMrectBannerCustomEvent.h"
#import <KiipSDK/KiipSDK.h>

@interface KPKiipMrectBannerCustomEvent ()<KPPoptartDelegate, KPModalDelegate>
@property (strong, nonatomic) KPNativeRewardView *nativeRewardView;
@end


@implementation KPKiipMrectBannerCustomEvent
...
static KPKiipMrectBannerCustomEvent *sInstance = nil;

+ (KPKiipMrectBannerCustomEvent *)sharedInstance
{
    @synchronized(self) {
        if (sInstance == nil) {
